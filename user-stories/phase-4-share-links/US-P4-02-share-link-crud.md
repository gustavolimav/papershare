...
- Relevant files:
  - `pages/api/v1/documents/[id]/links/index.ts` _(GET list + POST create)_
  - `pages/api/v1/documents/[id]/links/[linkId]/index.ts` _(PATCH + DELETE)_
  - `models/shareLink.ts` _(`create()`, `findAllByDocumentId()`, `findOneById()`, `updateById()`, `deleteById()`)_
  - `infra/schemas.ts` _(add `shareLinkCreateSchema`, `shareLinkUpdateSchema`)_
